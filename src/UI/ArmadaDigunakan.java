 ...
 * @author nabil
 */
public class ArmadaDigunakan extends javax.swing.JFrame {
int xMouse, yMouse;
    /**
     * Creates new form ArmadaDigunakan
     */
    ...
    private void initComponents() {
        ...
        jLabel3.setText("D A F T A R   A R M A D A   D I G U N A K A N");
    ...
    private void loadDataArmadaDigunakan() {
    DefaultTableModel model = new DefaultTableModel();
    model.addColumn("ID Armada Digunakan");
    ...
    try {
        ...
        String sql = "SELECT * FROM armada_digunakan";
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(sql);

        while (rs.next()) {
            model.addRow(new Object[]{
                rs.getInt("id_armada_digunakan"),
                rs.getInt("id_event"),
                rs.getInt("id_armada"),
    ...
    // Tengah hanya untuk kolom-kolom tertentu
javax.swing.table.DefaultTableCellRenderer centerRenderer = new javax.swing.table.DefaultTableCellRenderer();
centerRenderer.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

// Index kolom dimulai dari 0
jTable1.getColumnModel().getColumn(0).setCellRenderer(centerRenderer); // ID Armada Digunakan
jTable1.getColumnModel().getColumn(1).setCellRenderer(centerRenderer); // ID Event
jTable1.getColumnModel().getColumn(2).setCellRenderer(centerRenderer); // ID Armada
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArmadaDigunakan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArmadaDigunakan().setVisible(true);
            }
        });
    }
